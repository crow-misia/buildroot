...
WPA_SUPPLICANT_DEPENDENCIES += host-pkgconfig libressl
WPA_SUPPLICANT_LIBS += `$(PKG_CONFIG_HOST_BINARY) --libs openssl`
WPA_SUPPLICANT_CONFIG_EDITS += 's/\#\(CONFIG_TLS=openssl\)/\1/'
else
...
WPA_SUPPLICANT_CONFIG_DISABLE += CONFIG_CTRL_IFACE_DBUS_NEW CONFIG_CTRL_IFACE_DBUS_INTRO
endif
...
WPA_SUPPLICANT_CONFIG_DISABLE += CONFIG_READLINE
endif
